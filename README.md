# pandoc-latex-tip
[![Build Status](https://img.shields.io/travis/chdemko/pandoc-latex-tip/2.0.3.svg?logo=travis)](https://travis-ci.org/chdemko/pandoc-latex-tip/branches)
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-latex-tip/2.0.3.svg?logo=Codecov&logoColor=white)](https://coveralls.io/github/chdemko/pandoc-latex-tip?branch=2.0.3)
...
See the [Read the docs pages](http://pandoc-latex-tip.readthedocs.io/en/2.0.3/).
