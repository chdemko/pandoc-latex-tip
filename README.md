...
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-latex-tip/2.2.0.svg?logo=Codecov&logoColor=white)](https://coveralls.io/github/chdemko/pandoc-latex-tip?branch=2.2.0)
...
[![Docs](https://img.shields.io/readthedocs/pandoc-latex-tip.svg?logo=read-the-docs&logoColor=white)](http://pandoc-latex-tip.readthedocs.io/en/2.2.0/)
...
See the [Read the docs pages](http://pandoc-latex-tip.readthedocs.io/en/2.2.0/).
