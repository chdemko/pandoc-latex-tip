...
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-latex-tip/2.1.7.svg?logo=Codecov&logoColor=white)](https://coveralls.io/github/chdemko/pandoc-latex-tip?branch=2.1.7)
...
[![Docs](https://img.shields.io/readthedocs/pandoc-latex-tip.svg?logo=read-the-docs&logoColor=white)](http://pandoc-latex-tip.readthedocs.io/en/2.1.7/)
...
See the [Read the docs pages](http://pandoc-latex-tip.readthedocs.io/en/2.1.7/).
